  ...
  return <section className="relative py-20 bg-kitchen-wood text-white" style={{
    ...
    backgroundColor: "rgba(0,0,0,0.6)"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a href="https://wa.me/972542395502?text=היי%20אני%20מעוניין%2Fת%20לקבל%20הצעת%20מחיר" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-kitchen-accent hover:bg-opacity-90 text-white px-8 py-4 rounded-md text-xl font-medium border-black">
