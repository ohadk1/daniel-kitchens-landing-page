  ...
  return <section id="services" className="py-20 bg-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-kitchen-accent rounded-lg p-8 text-white text-center">
          ...
          <a href="https://wa.me/972542395502?text=היי%20אני%20מעוניין%2Fת%20לקבל%20הצעת%20מחיר" target="_blank" rel="noopener noreferrer" className="bg-#c0b8a8 text-kitchen-DEFAULT hover:bg-opacity-90 px-8 py-3 rounded-md text-white font-medium inline-block border-white border-2">
            לקבלת הצעת מחיר
          </a>
        </div>
      </div>
