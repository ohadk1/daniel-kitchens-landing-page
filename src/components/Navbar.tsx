    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div>
            <a href="https://wa.me/972542395502?text=היי%20אני%20מעוניין%2Fת%20לקבל%20הצעת%20מחיר" target="_blank" rel="noopener noreferrer" className="hidden md:inline-block bg-kitchen-accent hover:bg-opacity-90 text-white px-5 py-2 rounded-md text-lg font-medium">
              הצעת מחיר
            </a>
      ...
      {isOpen && <div className="md:hidden bg-black/95">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#gallery" onClick={() => setIsOpen(false)} className="text-white hover:text-kitchen-accent block px-3 py-2 rounded-md text-base font-medium">
              גלריה
            </a>
            <a href="#about" onClick={() => setIsOpen(false)} className="text-white hover:text-kitchen-accent block px-3 py-2 rounded-md text-base font-medium">
              אודות
            </a>
            <a href="#services" onClick={() => setIsOpen(false)} className="text-white hover:text-kitchen-accent block px-3 py-2 rounded-md text-base font-medium">
              שירותים
            </a>
            ...
            <a href="https://wa.me/972542395502?text=היי%20אני%20מעוניין%2Fת%20לקבל%20הצעת%20מחיר" target="_blank" rel="noopener noreferrer" className="bg-kitchen-accent hover:bg-opacity-90 text-white block px-3 py-2 rounded-md text-base font-medium">
              הצעת מחיר
            </a>
          </div>
        </div>}
